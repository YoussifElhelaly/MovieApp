...
export default function () {
    ...
    useEffect(()=> {
        fetch(`https://api.themoviedb.org/3/movie/${sort}?api_key=122131e3599c6bef391494f36765eaa0&language=en-US&page=${currentPage}`)
        .then((res) => res.json())
        ...
        <>
            <section className={`${styles.home} home h-1/4 py-16`}>
                <div className="container text-center mx-auto xl:p-20 px-2 py-10 w-full h-full ">
                    <h1 className='text-5xl font-bold'>MOVIE LISTING</h1>
                </div>
            </section>
            <div className="container mx-auto p-20">
                ...
                <div className="pages border-[0.5px] text-right border-l-0 border-r-0">
